...
.controller('registerCtrl', function($scope, $state, $stateParams, $ionicPopup, $timeout, $http) {
    ...
    $scope.submit = function(action, username, email, phone_number, password, confirm_password) {
...
.controller('accountSettingsCtrl', function($scope, $state, $stateParams, $ionicPopup, $timeout, $http) {
    ...
    var url_userdata = 'http://fadedbarbershop.co.uk/rest-all.php/client/user_data';
    ...
    var url = 'http://fadedbarbershop.co.uk/rest-all.php/client/user_data';
    ...
    $scope.submit = function(action, username, email, profile_picture, first_name, last_name, phone_number) {
        ...
        var url = 'http://fadedbarbershop.co.uk/rest-all.php/client/save_account_settings';
...
.controller('passwordSettingsCtrl', function($scope, $state, $stateParams, $ionicPopup, $timeout, $http) {
    ...
    $scope.submit = function(action, old_password, new_password, confirm_new_password) {
        ...
        var url = 'http://fadedbarbershop.co.uk/rest-all.php/client/save_password';
...
.controller('blogsCtrl', function($scope, $state, $stateParams, $ionicPopup, $timeout, $http) {
    ...
    var url = 'http://fadedbarbershop.co.uk/rest-all.php/client/blogs';
...
.controller('usersCtrl', function($scope, $state, $stateParams, $ionicPopup, $timeout, $http) {
    ...
    var url = 'http://fadedbarbershop.co.uk/rest-all.php/client/users';
...
.controller('usersMessageCtrl', function($scope, $state, $stateParams, $ionicPopup, $timeout, $http) {
    ...
    $scope.submit = function(action, to_user_id, content) {
        ...
        var url = 'http://fadedbarbershop.co.uk/rest-all.php/client/'.action;
...
.controller('usersRequestCtrl', function($scope, $state, $stateParams, $ionicPopup, $timeout, $http) {
    ...
    $scope.submit = function(action, provided_to_user_id, start, end) {
        ...
        var url = 'http://fadedbarbershop.co.uk/rest-all.php/client/users/request';
    ...
    var url = 'http://fadedbarbershop.co.uk/rest-all.php/client/requests';
...
.controller('requestsMessageCtrl', function($scope, $state, $stateParams, $ionicPopup, $timeout, $http) {
    ...
    $scope.submit = function(action, to_user_id, content) {
        ...
        var url = 'http://fadedbarbershop.co.uk/rest-all.php/client/request/messageuser';
...
.controller('messagesCtrl', function($scope, $state, $stateParams, $ionicPopup, $timeout, $http) {
    ...
    var url = 'http://fadedbarbershop.co.uk/rest-all.php/client/messages';
...
.controller('messagesReplyCtrl', function($scope, $state, $stateParams, $ionicPopup, $timeout, $http) {
    ...
    $scope.submit = function(action, to_user_id, content) {
        ...
        var url = 'http://fadedbarbershop.co.uk/rest-all.php/client/message/reply';
...
.controller('reviewsCtrl', function($scope, $state, $stateParams, $ionicPopup, $timeout, $http) {
    ...
    var url = 'http://fadedbarbershop.co.uk/rest-all.php/client/reviews';
...
.controller('socialCtrl', function($scope, $state, $stateParams, $ionicPopup, $timeout, $http) {
    ...
    var url = 'http://fadedbarbershop.co.uk/rest-all.php/client/product_data';
